...
from robot_data_platform.pipeline.lakehouse import result_to_dict, run_lakehouse_pipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the mini lakehouse pipeline.")
    parser.add_argument("--raw-path", default="data/raw/manufacturing_robot_events.csv")
