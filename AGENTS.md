# AGENTS.md — robot-data-platform-mini

AI-assisted development notes. Human scope and review gates stay in place.

## 이 프로젝트의 한 줄
ML/robot-style data platform의 핵심 루프(수집→카탈로그→버전/재현성→서빙)를 **얇게 한 번 관통**하는 public-safe demo.
...
## 코드 컨벤션
- Python 3.10+, `src/robot_data_platform/` 패키지 레이아웃.
